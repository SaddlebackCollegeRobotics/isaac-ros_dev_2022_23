...
CMakeFiles/yaml-cpp-populate-complete: yaml-cpp-populate-prefix/src/yaml-cpp-populate-stamp/yaml-cpp-populate-test
	...
	/usr/local/lib/python3.8/dist-packages/cmake/data/bin/cmake -E make_directory /workspaces/isaac_ros-dev/build/isaac_ros_nitros_occupancy_grid_type/_deps/yaml-cpp-subbuild/CMakeFiles
	/usr/local/lib/python3.8/dist-packages/cmake/data/bin/cmake -E touch /workspaces/isaac_ros-dev/build/isaac_ros_nitros_occupancy_grid_type/_deps/yaml-cpp-subbuild/CMakeFiles/yaml-cpp-populate-complete
	/usr/local/lib/python3.8/dist-packages/cmake/data/bin/cmake -E touch /workspaces/isaac_ros-dev/build/isaac_ros_nitros_occupancy_grid_type/_deps/yaml-cpp-subbuild/yaml-cpp-populate-prefix/src/yaml-cpp-populate-stamp/yaml-cpp-populate-done
...
yaml-cpp-populate-prefix/src/yaml-cpp-populate-stamp/yaml-cpp-populate-build: yaml-cpp-populate-prefix/src/yaml-cpp-populate-stamp/yaml-cpp-populate-configure
	...
	cd /workspaces/isaac_ros-dev/build/isaac_ros_nitros_occupancy_grid_type/_deps/yaml-cpp-build && /usr/local/lib/python3.8/dist-packages/cmake/data/bin/cmake -E echo_append
	cd /workspaces/isaac_ros-dev/build/isaac_ros_nitros_occupancy_grid_type/_deps/yaml-cpp-build && /usr/local/lib/python3.8/dist-packages/cmake/data/bin/cmake -E touch /workspaces/isaac_ros-dev/build/isaac_ros_nitros_occupancy_grid_type/_deps/yaml-cpp-subbuild/yaml-cpp-populate-prefix/src/yaml-cpp-populate-stamp/yaml-cpp-populate-build
...
yaml-cpp-populate-prefix/src/yaml-cpp-populate-stamp/yaml-cpp-populate-download: yaml-cpp-populate-prefix/src/yaml-cpp-populate-stamp/yaml-cpp-populate-mkdir
	...
	cd /workspaces/isaac_ros-dev/build/isaac_ros_nitros_occupancy_grid_type/_deps && /usr/local/lib/python3.8/dist-packages/cmake/data/bin/cmake -P /workspaces/isaac_ros-dev/build/isaac_ros_nitros_occupancy_grid_type/_deps/yaml-cpp-subbuild/yaml-cpp-populate-prefix/tmp/yaml-cpp-populate-gitclone.cmake
...
yaml-cpp-populate-prefix/src/yaml-cpp-populate-stamp/yaml-cpp-populate-mkdir:
	...
	/usr/local/lib/python3.8/dist-packages/cmake/data/bin/cmake -Dcfgdir= -P /workspaces/isaac_ros-dev/build/isaac_ros_nitros_occupancy_grid_type/_deps/yaml-cpp-subbuild/yaml-cpp-populate-prefix/tmp/yaml-cpp-populate-mkdirs.cmake
	/usr/local/lib/python3.8/dist-packages/cmake/data/bin/cmake -E touch /workspaces/isaac_ros-dev/build/isaac_ros_nitros_occupancy_grid_type/_deps/yaml-cpp-subbuild/yaml-cpp-populate-prefix/src/yaml-cpp-populate-stamp/yaml-cpp-populate-mkdir
...
yaml-cpp-populate-prefix/src/yaml-cpp-populate-stamp/yaml-cpp-populate-patch: yaml-cpp-populate-prefix/src/yaml-cpp-populate-stamp/yaml-cpp-populate-update
	...
	/usr/local/lib/python3.8/dist-packages/cmake/data/bin/cmake -E touch /workspaces/isaac_ros-dev/build/isaac_ros_nitros_occupancy_grid_type/_deps/yaml-cpp-subbuild/yaml-cpp-populate-prefix/src/yaml-cpp-populate-stamp/yaml-cpp-populate-patch
