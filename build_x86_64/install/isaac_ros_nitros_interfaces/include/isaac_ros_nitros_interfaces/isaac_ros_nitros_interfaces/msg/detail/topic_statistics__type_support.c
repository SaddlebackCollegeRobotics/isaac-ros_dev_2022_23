...
static rosidl_typesupport_introspection_c__MessageMember isaac_ros_nitros_interfaces__msg__TopicStatistics__rosidl_typesupport_introspection_c__TopicStatistics_message_member_array[5] = {
  {
    "node_name",  // name
