...
libencoder_node.so: /usr/lib/x86_64-linux-gnu/libpython3.8.so
libencoder_node.so: /workspaces/isaac_ros-dev/install/isaac_ros_nitros_interfaces/lib/libisaac_ros_nitros_interfaces__rosidl_typesupport_c.so
...
libencoder_node.so: /usr/lib/x86_64-linux-gnu/libopencv_calib3d.so.4.2.0
libencoder_node.so: /usr/lib/x86_64-linux-gnu/libopencv_features2d.so.4.2.0
libencoder_node.so: /usr/lib/x86_64-linux-gnu/libopencv_flann.so.4.2.0
libencoder_node.so: /usr/lib/x86_64-linux-gnu/libopencv_highgui.so.4.2.0
libencoder_node.so: /usr/lib/x86_64-linux-gnu/libopencv_videoio.so.4.2.0
libencoder_node.so: /opt/ros/humble/install/lib/libsensor_msgs__rosidl_generator_c.so
...
libencoder_node.so: /opt/ros/humble/install/lib/libstd_msgs__rosidl_typesupport_cpp.so
libencoder_node.so: /usr/lib/x86_64-linux-gnu/libopencv_imgcodecs.so.4.2.0
libencoder_node.so: /usr/lib/x86_64-linux-gnu/libopencv_imgproc.so.4.2.0
libencoder_node.so: /usr/lib/x86_64-linux-gnu/libopencv_core.so.4.2.0
